...
void MenuSystem::admin() {
        while(true) {
            try {
                ...
                cout << "1.Beans($20) 2.Milk($10) 3.Water($5) 4.Fruit($15) 5.Tea($10) 6.Snacks($20) 7.Back\nChoice: ";
                ...
                string msg = "";
                try {
                    if(c==1 && shop.getBank()>=20) { shop.getStorage().setBeans(shop.getStorage().getBeans()+1000); shop.subMoney(20); msg = "Bought 1000g of Beans!"; }
                    else if(c==2 && shop.getBank()>=10) { shop.getStorage().setMilk(shop.getStorage().getMilk()+2000); shop.subMoney(10); msg = "Bought 2000ml of Milk!"; }
                    else if(c==3 && shop.getBank()>=5) { shop.getStorage().setWater(shop.getStorage().getWater()+5000); shop.subMoney(5); msg = "Bought 5000ml of Water!"; }
                    else if(c==4 && shop.getBank()>=15) { shop.getStorage().setFruit(shop.getStorage().getFruit()+10); shop.subMoney(15); msg = "Bought 10pcs of Fruit!"; }
                    else if(c==5 && shop.getBank()>=10) { shop.getStorage().setTea(shop.getStorage().getTea()+20); shop.subMoney(10); msg = "Bought 20 bags of Tea!"; }
                    else if(c==6 && shop.getBank()>=20) { shop.getStorage().setSnacks(shop.getStorage().getSnacks()+10); shop.subMoney(20); msg = "Bought 10pcs of Snacks!"; }
